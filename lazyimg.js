...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.lazyimg = factory(root.jQuery);
    }
}(this, function ($) {
    ...
    var lazyimg = {
         ...
         * @param {String} type 元素类型，可用值 'img'|'bg'|dom'|'fn'|'bat'
    ...
    // 额外的绑定 jquery 插件
    $.fn.lazyimg = function (config, type, callback) {
        ...
        lazyimg.listen($(this), type, callback);
    };
